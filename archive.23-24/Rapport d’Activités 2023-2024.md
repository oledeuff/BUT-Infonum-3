# Consignes pour le rapport d'activités.
...
Voici les éléments attendus qui doivent être présents. Le rapport s'articule avec votre **portfolio**.
Le rapport donnera lieu à une soutenance.
...
Le rapport s'articule avec votre portfolio web. Idéalement, ce dernier doit se trouver dans un espace en ligne de type Github.
Il s'agit de mettre en avant les compétences et réalisations emblématiques de votre parcours et qui participent à la construction de votre *identité professionnelle*.

## Partie 1. Présentation des compétences développées et des expériences. (20 pages)
...
- Investissement et réussite durant les projets (il faut bien détailler pour les non alternants)
...
- Liens éventuels avec le projet de mémoire de master 

### 1.4 annexes
Placez ici les annexes utiles à la compréhension du mémoire d'activités et qui ne peuvent pas être intégrées dans le portfolio.
