...
:root {
  --color-primary: #15a4aeff; /* Pink color for primary elements */
...
![bg right 90%](./principes2.png)

---
## 4. Ethique et RSO
![bg right](./inclusion.png)
...
- formés à la complexité (Edgar Morin) dans des dispositifs hybrides.
- des spécialistes extérieurs aux organisations ou intérieurs, tension classique entre deux approches :
    - création de nouveaux métiers
    - ou développement de compétences tranversales au sein des processus métiers
![bg right 80%](./spécialistes.png)
---
...
- Version 2025. Licence CC mention de paternité O. Le Deuff
![bg right](./CCby.png)
