...
- **Format universel** : Le  ![Markdown Image](./img/markdown.png) [Markdown](https://daringfireball.net/projects/markdown/) est largement accepté et peut être converti en de nombreux autres formats.
