...
section {
    ...
    background-color: #F9FAFB; /* Fond clair élégant */
    color: #1E293B; /* Texte gris foncé lisible */
    position: relative;
    padding-top: 40px; /* Espace pour le fil d’Ariane */
}

/* Style pour les titres */
h1 {
    color: #0F62FE; /* Bleu "data" IBM */
    font-weight: 700;
...
section p:first-child {
    ...
    margin: 0;
    padding: 10px 0;
    background: linear-gradient(90deg, #0F62FE, #42BE65); /* Dégradé bleu-vert "data & insights" */
    position: absolute;
    top: 0;
    left: 0;
    right: 0;
    border-bottom: 2px solid #E2E8F0; /* Bordure discrète */
    color: #ffffff;
    font-weight: 500;
}
...
section p:first-child strong {
    ...
    background-color: #FACC15; /* Jaune vif pour mettre en avant */
    padding: 2px 12px;
    border-radius: 5px;
